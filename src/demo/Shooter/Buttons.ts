...
export default class Buttons {
    ...
    constructor() {
        ...
        this.jump = new PIXI.Sprite(PIXI.Texture.from("src/demo/Shooter/Image/jump.png"));
        this.jump.x = 50;
        this.jump.y = window.app.screen.height - 200;
        this.jump.width = 150;
        this.jump.height = 150;

        this.down = new PIXI.Sprite(PIXI.Texture.from("src/demo/Shooter/Image/jump.png"));
        this.down.x = 125;
        ...
        this.shoot = new PIXI.Sprite(PIXI.Texture.from("src/demo/Shooter/Image/shot.png"));
        ...
        this.reload = new PIXI.Sprite(PIXI.Texture.from("src/demo/Shooter/Image/Reloading.png"));
