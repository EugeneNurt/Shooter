...
export default class Shot {
    ...
    constructor() {
        ...
        for (let i = 0; i < this.count_heart; i++) {
            this.heart[i] = new PIXI.Sprite(PIXI.Texture.from("src/demo/Shooter/Image/heart.png"));
        ...
        for (let i = 0; i < this.count_shot; i++) {
            this.shot[i] = new PIXI.Sprite(PIXI.Texture.from("src/demo/Shooter/Image/Cartridge.png"));
